...
(defvar bibtex-actions-map
  (let ((map (make-sparse-keymap "BibTeX actions")))
    (define-key map "o" '("Open pdf or link" . bibtex-actions-open))
    (define-key map "p" '("Open pdf" . bibtex-actions-open-pdf))
    (define-key map "l" '("Open link" . bibtex-actions-open-link))
    (define-key map "c" '("Insert citation" . bibtex-actions-insert-citation))
    (define-key map "r" '("Insert reference" . bibtex-actions-insert-reference))
    (define-key map "k" '("Insert citekey" . bibtex-actions-insert-key))
    ...
    (define-key map "e" '("Open bibtex entry" . bibtex-actions-open-entry))
