...
;; Package-Requires: ((emacs "29.1") (parsebib "4.2") (org "9.5") (citeproc "0.9"))
...
(defun citar--multiple-exit ()
  ...
  (interactive)
  (call-interactively (key-binding (kbd (car citar--multiple-setup)))))
...
(defun citar-attach-files (citekey-or-citekeys)
  "Attach file associated with CITEKEY-OR-CITEKEYS to outgoing MIME message."
  (interactive (list (citar-select-ref)))
