...
(use-package bibtex-actions
  ...
  (bibtex-actions-bibliography '("~/bib/references.bib")))
#+END_SRC
...
The behavior can be tweaked more thoroughly by setting =bibtex-actions-filenotify-callback= to a function. See its documentation for details.
