...
If a bib file changes, the cache should automatically update the next time you run a citar command.

The =citar-cache-refresh= command will reload the caches.
