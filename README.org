...
While currently subject to some limitations (see [[https://github.com/emacs-citar/citar/issues/660][issue 660]]), this package includes a completion-at-point function, which you can configure like so:
