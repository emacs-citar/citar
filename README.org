...
#+BEGIN_SRC emacs-lisp
(bibtex-actions-file-notify-setup '(LaTeX-mode-hook org-mode-hook))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(setq bibtex-actions-file-notify-callback 'refresh-cache)
#+END_SRC

The behavior can be tweaked more thoroughly by setting =bibtex-actions-file-notify-callback= to a function. See its documentation for details.
Watches can be also placed on additional files. This is controlled by the variable =bibtex-actions-file-notify-files=.
